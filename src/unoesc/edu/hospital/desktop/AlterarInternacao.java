...
public class AlterarInternacao extends JFrame{
	...
	AlterarInternacao(){
        ...
        jbtCadastrar.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent arg0) {
				...
				pagamento = pagamentoDao.listarTodos().get(Integer.valueOf(jtfGuardaValor.getText()));
				internacao = internacaoDao.listarTodos().get(Integer.valueOf(jtfGuardaValor.getText()));
