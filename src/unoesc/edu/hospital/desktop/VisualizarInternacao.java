...
public class VisualizarInternacao extends JFrame{
    ...
    public void setValor1(int a) {
		...
		jtfCOdigoAIH.setText(internacaoDao.listarTodos().get(a).getCodigoAIH().toString());
		jtfDataAlta.setText(internacaoDao.listarTodos().get(a).getDataAlta().toString());
		jtfDataInternacao.setText(internacaoDao.listarTodos().get(a).getDataInternacao().toString());
		jtfDataPagamento.setText(internacaoDao.listarTodos().get(a).getPagamento().getData().toString());
		jtfNumeroQuarto.setText(internacaoDao.listarTodos().get(a).getNumeroQuarto().toString());
		jtfValorDiaria.setText(internacaoDao.listarTodos().get(a).getValorDiaria().toString());	
		jtfValorPago.setText(internacaoDao.listarTodos().get(a).getPagamento().getValor().toString());
		for(Hospital hospital:hospitalDao.listarTodos()){
			if(hospital.getNome().equals(internacaoDao.listarTodos().get(a).getHospital().getNome())){
				jcbHospital.setSelectedItem(hospital.getNome());
			}
		}
		for(Medico medico:medicoDao.listarTodos()){
			if(medico.getNome().equals(internacaoDao.listarTodos().get(a).getMedico().getNome())){
				jcbMedico.setSelectedItem(medico.getNome());
			}
		}
		for(Paciente paciente:pacienteDao.listarTodos()){
			if(paciente.getNome().equals(internacaoDao.listarTodos().get(a).getPaciente().getNome())){
				jcbPaciente.setSelectedItem(paciente.getNome());
			}
		}
...
jtfCOdigoAIH.setEditable(false);
jtfDataAlta.setEditable(false);
jtfDataInternacao.setEditable(false);
jtfDataPagamento.setEditable(false);
jtfNumeroQuarto.setEditable(false);
jtfValorDiaria.setEditable(false);
jtfValorPago.setEditable(false);
jcbCodigoCID.setEditable(false);
jcbHospital.setEditable(false);
jcbMedico.setEditable(false);
jcbPaciente.setEditable(false);

}
	VisualizarInternacao(){
